...
<cfset variables['category_service'] = new root.exercise2.com.example.CategoryService()/>
<!--- get the categories --->
<cfset variables['site_categories'] = variables.category_service.getCategories()/>
<!--- get a handle to the brand service --->
<cfset variables['brand_service'] = new root.exercise2.com.example.BrandService()/>
<!--- get the site brands --->
