...
<cfset variables['category_service'] = new root.exercise8_completed.com.example.CategoryService()/>
<!--- get the categories --->
<cfset variables['site_categories'] = variables.category_service.getCategories()/>
<!--- get a handle to the brand service --->
<cfset variables['brand_service'] = new root.exercise8_completed.com.example.BrandService()/>
<!--- get the site brands --->
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					<cfinclude template="/root/exercise8_completed/view/layout/layout.header.cart.cfm"/>
				</li>
			</ul>
			<!--- start of search / cart nav --->
		</div>
