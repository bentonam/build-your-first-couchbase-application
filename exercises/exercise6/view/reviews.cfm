...
<div class="product-detail">
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-5">
			<cfinclude template="/root/exercise6/view/includes/product.images.cfm"/>
		</div>
		<!--- end of images --->
		<!--- start of info --->
		<div class="col-sm-12 col-md-7">
			<cfinclude template="/root/exercise6/view/includes/product.info.cfm"/>
		</div>
		<!--- end of info --->
	</div>
	<!--- start of tabs --->
	<div class="row">
		<div class="col-md-12">
				<cfinclude template="/root/exercise6/view/includes/product.tabs.reviews.cfm"/>
		</div>
	</div>
	<!--- end of tabs --->
	<!--- start of pagination --->
