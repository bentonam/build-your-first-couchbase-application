...
<cfset variables['brand_service'] = new root.exercise6_completed.com.example.BrandService()/>
<!--- get the site brands --->
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					<cfinclude template="/root/exercise6_completed/view/layout/layout.header.cart.cfm"/>
				</li>
			</ul>
			<!--- start of search / cart nav --->
		</div>
