...
<form action="cart.cfm" method="post">
	...
	<!--- end of breadcrumb --->
	<!--- start of billing --->
	<cfinclude template="/root/exercise4_completed/view/includes/checkout.billing.cfm"/>
	<!--- end of billing --->
	<!--- start of shipping --->
	<cfinclude template="/root/exercise4_completed/view/includes/checkout.shipping.cfm"/>
	<!--- end of shipping --->
	<!--- start of payment details --->
	<cfinclude template="/root/exercise4_completed/view/includes/checkout.payment.cfm"/>
