...
<cfset variables['product_service'] = new root.exercise4_completed.com.example.ProductService()/>
...
<div class="product-listing">
	...
	<div class="row">
		...
		<cfloop collection="#variables.recent_products#" item="variables.product_id">
			...
			<cfinclude template="/root/exercise4_completed/view/includes/template.product.cfm"/>
		</cfloop>
	</div>
</div>
</cfoutput>