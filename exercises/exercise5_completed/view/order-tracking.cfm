...
<hr /><!--- start of billing --->
<cfinclude template="/root/exercise5_completed/view/includes/invoice.details.cfm"/>
<!--- end of billing --->
<!--- start of payment details --->
<cfinclude template="/root/exercise5_completed/view/includes/invoice.items.cfm"/>
