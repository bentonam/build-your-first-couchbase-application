...
<body>
<cfinclude template="/root/exercise3/view/layout/layout.header.cfm"/>
<div class="container">
	<div class="row">
		<div id="sidebar" class="col-md-3 hidden-xs hidden-sm">
			<cfinclude template="/root/exercise3/view/layout/layout.sidebar.cfm"/>
		</div>
...
<cfinclude template="/root/exercise3/view/layout/layout.footer.cfm"/>
</body>
</html>
</cfoutput>