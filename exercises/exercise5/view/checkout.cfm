...
<form action="cart.cfm" method="post">
	...
	<!--- end of breadcrumb --->
	<!--- start of billing --->
	<cfinclude template="/root/exercise5/view/includes/checkout.billing.cfm"/>
	<!--- end of billing --->
	<!--- start of shipping --->
	<cfinclude template="/root/exercise5/view/includes/checkout.shipping.cfm"/>
	<!--- end of shipping --->
	<!--- start of payment details --->
	<cfinclude template="/root/exercise5/view/includes/checkout.payment.cfm"/>
	<!--- end of payment details --->
	<!--- start of order totals --->
	<cfinclude template="/root/exercise5/view/includes/checkout.totals.cfm"/>
	<!--- end of order totals --->
	<hr />
	<div class="row">
