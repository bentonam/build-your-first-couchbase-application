...
<cfset products = product_service.getProductsBySearch(keyword=urlDecode(url.keyword), limit=url.limit, offset=url.offset)/>
...
<div class="product-listing">
	<div class="row headline">
		<h2 class="col-md-8">Your search for "#urlDecode(url.keyword)#" returned #products.total# results</h2>
	</div>
	<div class="row">
...
<!--- start of pagination --->
<ul class="pagination">
	<li><a href="?brand=#urlEncodedFormat(url.keyword)#&offset=#pagination.first_offset#">First</a></li>
	<cfif pagination.has_previous>
		<li><a href="?brand=#urlEncodedFormat(url.keyword)#&offset=#pagination.previous_offset#">«</a></li>
	</cfif>
	<cfloop array="#pagination.pages#" index="page">
		...
		<cfelse>
			<li><a href="?brand=#urlEncodedFormat(url.keyword)#&offset=#page.offset#">#page.number#</a></li>
		</cfif>
	</cfloop>
	<cfif pagination.has_next>
		<li><a href="?brand=#urlEncodedFormat(url.keyword)#&offset=#pagination.next_offset#">»</a></li>
	</cfif>
	<li><a href="?brand=#urlEncodedFormat(url.keyword)#&offset=#pagination.last_offset#">Last</a></li>
</ul>
<!--- end of pagination --->
</cfoutput>